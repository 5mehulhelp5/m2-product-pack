...
namespace Qoliber\ProductPack\Model\Product;
...
class Price extends PriceModel
{
    ...
    public function __construct(
        ...
        $this->serializer = $serializer instanceof Json ? $serializer : ObjectManager::getInstance()
            ->get(Json::class);
    }
    ...
    public function getPrice($product)
    {
        ...
        if ($customOption instanceof OptionInterface) {
    ...
    public function getFinalPrice($qty, $product)
    {
        ...
        if ($customOption instanceof OptionInterface) {
            ...
            if ($packOption) {
                if ((float)$product->getSpecialPrice() !== 0.0) {
    ...
    public function getTierPrice($qty, $product)
    {
        ...
        if ($customOption instanceof OptionInterface) {
            ...
            if (($packOption = $buyRequest['pack_option'] ?? null) && (int)$packOption['pack_size'] === 1) {
